...
-- VERSIÓN COMPLETA (incluye función update_updated_at_column)
-- ═══════════════════════════════════════════════════════
--
...
-- ───────────────────────────────────────────────────────
-- Si ya existe, la reemplaza (CREATE OR REPLACE)
...
-- ───────────────────────────────────────────────────────
-- Usar DO block para evitar error si ya existe
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'check_empresa_id'
  ) THEN
