    ...
    <View style={styles.busCard}>
      ...
      {item.mantenimientos.length > 0 ? (
        ...
        <View style={styles.sinDatos}>
          ...
          <Text style={styles.sinDatosText}>Sin datos de mantenimiento</Text>
        </View>
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  filtrosEstado: { flexDirection: 'row', paddingHorizontal: 15, paddingBottom: 15, gap: 8 },
  filtroEstadoButton: {
    flex: 1,
    paddingVertical: 8,
    paddingHorizontal: 8,
  ...
  filtroEstadoButtonActive: { backgroundColor: COLORS.card, borderColor: COLORS.primary },
  filtroEstadoText: { fontSize: 11, fontWeight: '600', color: COLORS.textMuted },
  filtroEstadoTextActive: { color: COLORS.text },
  ...
  statLabel: { fontSize: 11, color: COLORS.textMuted, marginTop: 5 },
  lista: { padding: 15, paddingTop: 0, paddingBottom: 30 },
  busCard: {
    backgroundColor: COLORS.card,
    borderRadius: 12,
    padding: 15,
  ...
  busInfo: { flex: 1 },
  busPlaca: { fontSize: 18, fontWeight: 'bold', color: COLORS.text, marginBottom: 5 },
  busKmRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  busKm: { fontSize: 13, fontWeight: '600', color: COLORS.accent },
  busBadges: { flexDirection: 'row', gap: 5 },
  badge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  badgeText: { fontSize: 11, fontWeight: 'bold', color: COLORS.text },
  mantenimientosContainer: { gap: 12 },
  mantenimientoItem: {
    backgroundColor: COLORS.backgroundLight,
    borderRadius: 8,
    padding: 12,
  ...
  mantenimientoHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 },
  mantenimientoNombre: { flex: 1, fontSize: 14, fontWeight: '600', color: COLORS.text },
  estadoBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6 },
  estadoText: { fontSize: 10, fontWeight: 'bold', color: COLORS.text },
  mantenimientoInfo: { gap: 6 },
  ...
  sinDatosText: { fontSize: 13, color: COLORS.textMuted, fontStyle: 'italic' },
